...
namespace Task_Tracker
{
    public partial class EditTaskForm : Form
    {
        ...
        {
            Task toEdit = DBInterface.GetTask(currentTask.ID);
            if (toEdit.CompletionDate == null && toEdit.Active == true)
            {

                toEdit.Active = false;
                toEdit.Description = "Deleted";
                DBInterface.Update(toEdit);
                this.sender.ReloadData();
                this.Dispose();
            ...
            {
                if (toEdit.Active == false) {
                        MessageBox.Show("Task is currenlty set to: " + toEdit.Active + " Cannot delete an inactive task" + MessageBoxButtons.OK);
                } 
                else if (localDate != null)
                {
                    MessageBox.Show("Task Should have been Completed on: " + toEdit.CompletionDate + " Please increase Completion Date if this is incorrect" + MessageBoxButtons.OK);
                }
